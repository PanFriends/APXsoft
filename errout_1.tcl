proc errout {par {predelta 0} {uponly 0} {doonly 0}{
    ...
    #uponly is optional; if non-zero only the upper 90% boundshould be sought
...
#Cleanup
file delete prov prov2 tb271.txt partop1.txt partop2.txt parbot1.txt parbot2.txt sp271.txt zm271.txt
