proc plomod {xcmfile} {
	...
	if { $pin == 1 } {
	    ...
	    setplot command co 2 on [expr 3+$numplus]
...
#	setplot command lab  9 vpos $vlet $vobs cs 2 \"$obs\"
    ...
    exec mv provcon.pco $name\_$obs\_$xcm\_MO.pco
    exec mv provcon.qdp $name\_$obs\_$xcm\_MO.qdp
    exec mv pgplot.ps   $name\_$obs\_$xcm\_MO.eps
