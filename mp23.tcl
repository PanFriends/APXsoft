...
if {[file exists "mp23_lo_hi.txt"]==1} {
    scan [exec more mp23_lo_hi.txt] "%f %f" ylo yhi
}
...
exec echo $ylo $yhi > "mp23_lo_hi.txt"
...
exec mv provcon.pco $objname\_$obs\_DA23.pco
exec mv provcon.qdp $objname\_$obs\_DA23.qdp
exec mv pgplot.ps   $objname\_$obs\_DA23.eps

#Fix new pco file
exec rnamepco2 $objname\_$obs\_DA23.pco $objname\_$obs\_DA23.qdp

echo $objname\_$obs\_DA23.pco > /tmp/namprov
echo $objname\_$obs\_DA23.qdp >> /tmp/namprov
echo $objname\_$obs\_DA23.eps >> /tmp/namprov 

more /tmp/namprov
mv /tmp/namprov FILES_DA_23_first.txt
