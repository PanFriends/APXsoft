proc mytzon {} {
    ...
    #IDENTICAL to toMYTz.tcl; exists for symmetry with mytzoff.tcl
    ...
    exec sed {s/mytorus_Ezero_v00.fits\} + zpowerlw/mytorus_Ezero_v00.fits\}*zpowerlw/} prov2.xcm > prov2A.xcm 
    ...
    exec /bin/rm prov.xcm prov2.xcm prov2A.xcm prov3.xcm prov4.xcm
