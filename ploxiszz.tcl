proc ploxiszz {xcmfile} {
    ...
    exec mv provcon.pco $name\_$obs\_$xcm\_DA.pco
    exec mv provcon.qdp $name\_$obs\_$xcm\_DA.qdp
    exec mv pgplot.ps   $name\_$obs\_$xcm\_DA.eps
